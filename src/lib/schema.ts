...
export const organizationSchema = {
  ...
  description:
    "Free currency calculator with live exchange rates for 170+ currencies. Progressive Web App with offline functionality.",
  ...
  review: [
    {
      ...
      reviewBody:
        "Sehr praktischer Währungsrechner! Funktioniert auch ohne Internet perfekt. Ideal für Reisen.",
    },
    {
      "@type": "Review",
      author: {
      ...
      reviewBody:
        "Best currency calculator I've used. Clean interface and accurate rates. The PWA works great!",
    },
  ],
};
...
export const financialServiceSchema = {
  ...
  name: "Currency Exchange Calculator",
  description:
    "Professional currency conversion tool with real-time exchange rates",
...
export const createCurrencyConversionSchema = (
  ...
  // Removed dynamic dates to prevent hydration mismatch
  // These would be populated dynamically when needed
});
