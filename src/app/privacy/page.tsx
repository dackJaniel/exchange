...
export const metadata: Metadata = {
  title: 'Privacy Policy | Currency Calculator',
  description: 'Privacy Policy for the Currency Exchange Calculator',
          ...
          <div className='space-y-6 text-zinc-300 leading-relaxed'>
            <div className='space-y-4'>
              ...
              <p>
                ...
                your user patterns. If contracts can be concluded or initiated
                via the website, the transmitted data will also be processed for
              ...
              <p>
                The provider is the Hetzner Online GmbH, Industriestr. 25, 91710
                Gunzenhausen, Germany (hereinafter referred to as Hetzner).
              </p>
              <p>
              ...
              <p>
                ...
                legitimate interest in the most reliable depiction of our
              ...
              <p>
                ...
                25 (1) TDDDG. The consent can be revoked at any time. If your
              ...
              <p>
                ...
                various external parties. In some cases, this also requires the
                transfer of personal data to these external parties. We only
                disclose personal data to external parties if this is required
                as part of the fulfillment of a contract, if we are legally
                obligated to do so (e.g., disclosure of data to tax
                authorities), if we have a legitimate interest in the disclosure
                pursuant to Art. 6 (1)(f) GDPR, or if another legal basis
                permits the disclosure of this data. When using processors, we
                only disclose personal data of our customers on the basis of a
                valid contract on data processing. In the case of joint
