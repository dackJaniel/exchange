...
export default function Convert500EURToCHF() {
  ...
  const toCurrency = getCurrencyByCode('CHF') || currencies.find(c => c.code === 'USD')!;
  ...
  useEffect(() => {
    const fetchRate = async () => {
      try {
        ...
        if (baseCurrency.code === 'EUR' && targetCurrency.code === 'CHF') {
  ...
  const faqData = [
    {
      question: "How much is 500 Euro in Swiss Franc?",
      answer: result
        ? `500 Euro equals ${formatNumber(result)} Swiss Franc at the current exchange rate of ${rate?.toFixed(4)}.`
        : `The current exchange rate will determine how much 500 Euro is worth in Swiss Franc.`
    },
    {
      question: "Is 500 EUR to CHF a good conversion rate?",
    ...
    {
      question: "Can I convert 500 EUR to CHF offline?",
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebApplication",
            "name": "500 Euro to Swiss Franc Converter",
            "description": "Convert 500 EUR to CHF with live exchange rates",
            "url": "https://exchange.danielhilmer.de/convert/500-euro-to-franken",
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <nav className="mb-6 text-sm">
          ...
          <span className="mx-2 text-gray-500">›</span>
          <span className="text-gray-300">500 EUR to CHF</span>
        </nav>

        {/* Header */}
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            500 Euro to Swiss Franc Converter
          </h1>
          <p className="text-gray-300 text-lg">
            Convert 500 EUR to CHF with live exchange rates
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-400">
                {rate ? `1 EUR = ${rate.toFixed(4)} CHF` : 'Loading rate...'}
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {relatedAmounts.map(relatedAmount => {
              ...
              return (
                <Link
                  key={relatedAmount}
                  href={`/convert/${relatedAmount}-euro-to-franken`}
                ...
                >
                  ...
                  <div className="text-sm text-gray-400">
                    {relatedResult ? `≈ ${formatNumber(relatedResult)} CHF` : 'Calculate'}
                  </div>
                </Link>
              );
            })}
        ...
        <div className="bg-zinc-900 rounded-lg p-6">
          <h2 className="text-xl font-bold mb-4">Why Use Our EUR to CHF Converter?</h2>
          <div className="text-gray-300 space-y-3">
            <p>
              Our free 500 Euro to Swiss Franc converter provides
