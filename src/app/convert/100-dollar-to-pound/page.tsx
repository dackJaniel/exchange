...
export default function Convert100USDToGBP() {
  ...
  const relatedAmounts = [500, 1000, 50, 200];

  // FAQ data
  const faqData = [
    {
      question: "How much is 100 US Dollar in British Pound?",
      answer: result
        ? `100 US Dollar equals ${formatNumber(result)} British Pound at the current exchange rate of ${rate?.toFixed(4)}.`
        : `The current exchange rate will determine how much 100 US Dollar is worth in British Pound.`
    },
    {
      question: "Is 100 USD to GBP a good conversion rate?",
    ...
    {
      question: "Can I convert 100 USD to GBP offline?",
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebApplication",
            "name": "100 US Dollar to British Pound Converter",
            "description": "Convert 100 USD to GBP with live exchange rates",
            "url": "https://exchange.danielhilmer.de/convert/100-dollar-to-pound",
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <nav className="mb-6 text-sm">
          ...
          <span className="mx-2 text-gray-500">›</span>
          <span className="text-gray-300">100 USD to GBP</span>
        </nav>

        {/* Header */}
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            100 US Dollar to British Pound Converter
          </h1>
          <p className="text-gray-300 text-lg">
            Convert 100 USD to GBP with live exchange rates
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
            <div className="text-center">
              <div className="text-2xl font-bold text-orange-500">
                {fromCurrency.flag} {formatNumber(100)}
              </div>
        ...
        <div className="bg-zinc-900 rounded-lg p-6">
          ...
          <div className="text-gray-300 space-y-3">
            <p>
              Our free 100 US Dollar to British Pound converter provides
