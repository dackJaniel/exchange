...
export default function Convert100EURToUSD() {
  ...
  const faqData = [
    {
      question: "How much is 100 Euro in US Dollar?",
      answer: result
        ? `100 Euro equals ${formatNumber(result)} US Dollar at the current exchange rate of ${rate?.toFixed(4)}.`
        : `The current exchange rate will determine how much 100 Euro is worth in US Dollar.`
    },
    {
      question: "Is 100 EUR to USD a good conversion rate?",
    ...
    {
      question: "Can I convert 100 EUR to USD offline?",
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebApplication",
            "name": "100 Euro to US Dollar Converter",
            "description": "Convert 100 EUR to USD with live exchange rates",
            "url": "https://exchange.danielhilmer.de/convert/100-euro-to-dollar",
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <nav className="mb-6 text-sm">
          ...
          <span className="mx-2 text-gray-500">›</span>
          <span className="text-gray-300">100 EUR to USD</span>
        </nav>

        {/* Header */}
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            100 Euro to US Dollar Converter
          </h1>
          <p className="text-gray-300 text-lg">
            Convert 100 EUR to USD with live exchange rates
          </p>
        </div>
        ...
        <div className="bg-zinc-900 rounded-lg p-6">
          ...
          <div className="text-gray-300 space-y-3">
            <p>
              Our free 100 Euro to US Dollar converter provides
